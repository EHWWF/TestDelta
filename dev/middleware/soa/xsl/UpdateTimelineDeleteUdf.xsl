  ...
  <xsl:template match="/">
    <tns:DeleteUDFValues>
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:studyPhase]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:studyPhaseTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:planPatients]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:planPatientsTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:actualPatients]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:actualPatientsTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:planEnteredScreen]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:planEnteredScreenTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:actEnteredScreen]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:actEnteredScreenTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:studyCountryCountPlan]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:studyCountryCountPlanTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:studyCountryCount]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:studyCountryCountTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:studyUnitCount]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:studyUnitCountTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:studyUnitCountPlan]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:studyUnitCountPlanTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
      ...
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:FTEAvg]">
        <tns:ObjectId>
          <tns:UDFTypeObjectId>
            <xsl:value-of select="$ReadConfigurationOut.payload/ns11:config/ns11:wbs/ns11:FTEAvgTypeId"/>
          </tns:UDFTypeObjectId>
          <tns:ForeignObjectId>
            <xsl:value-of select="@id"/>
          </tns:ForeignObjectId>
