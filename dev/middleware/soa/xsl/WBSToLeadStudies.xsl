...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns0="http://xmlns.oracle.com/Primavera/P6/WS/WBS/V2"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      ...
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:param name="LeadStudies.result"/>
      </oracle-xsl-mapper:source>
      <oracle-xsl-mapper:source type="WSDL">
        <oracle-xsl-mapper:schema location="oramds:/apps/com/oracle/xmlns/Primavera/P6/WS/UDFValue/V1/UDFValueService.wsdl"/>
        <oracle-xsl-mapper:rootElement name="ReadUDFValuesResponse"
                                       namespace="http://xmlns.oracle.com/Primavera/P6/WS/UDFValue/V1"/>
        <oracle-xsl-mapper:param name="StudyPhases.result"/>
      </oracle-xsl-mapper:source>
    </oracle-xsl-mapper:mapSources>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU MAR 17 19:49:01 EET 2016].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="LeadStudies.result"/>
  <xsl:param name="StudyPhases.result"/>
  <xsl:template match="/">
    <tns:leadStudies>
      <tns:studies>
        <xsl:for-each select="/ns0:ReadWBSResponse/ns0:WBS">
          <xsl:variable name="wbsId" select="./ns0:ObjectId/text()"/>
          <tns:study wbsId="{ns0:ObjectId}"
                     isLead="{boolean($LeadStudies.result/ns1:ReadUDFValuesResponse/ns1:UDFValue/ns1:Text[../ns1:ForeignObjectId=$wbsId]='true')}">
            <tns:name>
              <xsl:value-of select="ns0:Name"/>
            </tns:name>
            <tns:phaseName>
              <xsl:value-of select="$StudyPhases.result/ns1:ReadUDFValuesResponse/ns1:UDFValue/ns1:Text[../ns1:ForeignObjectId=$wbsId]"/>
            </tns:phaseName>
          </tns:study>
        </xsl:for-each>
      </tns:studies>
