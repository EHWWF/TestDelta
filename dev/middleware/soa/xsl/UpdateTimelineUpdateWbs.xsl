...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns1="http://xmlns.bayer.com/ipms" xmlns:tns="http://xmlns.oracle.com/Primavera/P6/WS/WBS/V2"
                ...
                exclude-result-prefixes="xsi xsl plnk wsdl ns1 client xsd soap tns intgfault xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref bpmn ldap"
  ...
  <xsl:template match="/">
    <tns:UpdateWBS>
      <xsl:for-each select="/client:update/ns1:timeline/ns1:wbsNodes/ns1:wbs[ns1:name]">
        <tns:WBS>
          <tns:Name>
          ...
          <xsl:if test="ns1:categoryObjectId">
            <tns:WBSCategoryObjectId>
              <xsl:value-of select="ns1:categoryObjectId"/>
            </tns:WBSCategoryObjectId>
          </xsl:if>
