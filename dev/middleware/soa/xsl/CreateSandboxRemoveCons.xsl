...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                ...
                exclude-result-prefixes="xsi xsl intgfault tns xsd soap wsdl ns0 bpws xp20 mhdr bpel oraext dvm hwf med ids bpm xdk xref bpmn ora socket ldap"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="UpdateActivities"
  ...
  <xsl:template match="/">
    <ns0:UpdateActivities>
      <xsl:for-each select="/tns:ReadActivityCodeAssignmentsResponse/tns:ActivityCodeAssignment">
        <ns0:Activity>
          <ns0:ObjectId>
            <xsl:value-of select="tns:ActivityObjectId"/>
          </ns0:ObjectId>
