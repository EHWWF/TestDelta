create table import_resources_cs (
...
create index import_resources_cs_idx1 on import_resources_cs(import_id);
create index import_resources_cs_idx2 on import_resources_cs(project_id);