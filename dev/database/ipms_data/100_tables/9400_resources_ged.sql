create sequence resources_ged_id_seq maxvalue 9999999999999999999 minvalue 1 cycle;

create table resources_ged (
...
create index resources_ged_idx1 on resources_ged(project_id);